...
if UT.Spawn.mode == "enemies" then
    ...
    UT.showSubtitle(UT.getFilename(UT.Tables.enemies[UT.Spawn.index]), UT.colors.blue)
...
elseif UT.Spawn.mode == "civilians" then
    ...
    UT.showSubtitle(UT.getFilename(UT.Spawn.available.civilians[UT.Spawn.index]), UT.colors.blue)
elseif UT.Spawn.mode == "loots" then
    if UT.Spawn.index == UT.countTable(UT.Spawn.available.loots) then UT.Spawn.index = 1
    else UT.Spawn.index = UT.Spawn.index + 1 end
    UT.showSubtitle(UT.getFilename(UT.Spawn.available.loots[UT.Spawn.index]), UT.colors.blue)
elseif UT.Spawn.mode == "equipments" then
    if UT.Spawn.index == UT.countTable(UT.Spawn.available.equipments) then UT.Spawn.index = 1
    else UT.Spawn.index = UT.Spawn.index + 1 end
    UT.showSubtitle(UT.Spawn.available.equipments[UT.Spawn.index], UT.colors.blue)
elseif UT.Spawn.mode == "packages" then
    if UT.Spawn.index == UT.countTable(UT.Spawn.available.packages) then UT.Spawn.index = 1
    else UT.Spawn.index = UT.Spawn.index + 1 end
    UT.showSubtitle(UT.getFilename(UT.Spawn.available.packages[UT.Spawn.index]), UT.colors.blue)
else
    UT.showMessage("no mode selected", UT.colors.orange, "spawn")
end