...
if not crosshairRay then
    UT.showMessage("nothing to copy", UT.colors.red, "construction")
    do return end
end

local unit = crosshairRay.unit

if unit:base() or UT.Tables.bags[unit:name():key()]then
    UT.showMessage("cannot copy this", UT.colors.red, "construction")
    do return end
end
