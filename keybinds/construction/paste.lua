...
if not Network:is_server() then
    UT.showMessage("host only", UT.colors.red, "construction")
    do return end
end

if not UT.checkTable(UT.Construction.clipboard) then
    UT.showMessage("no unit copied", UT.colors.red, "construction")
    do return end
end
...
if not crosshairRay then
    UT.showMessage("impossible to paste", UT.colors.red, "construction")
    do return end
end
...
if not unit then
    UT.showMessage("paste failed", UT.colors.red, "construction")
    do return end
end
