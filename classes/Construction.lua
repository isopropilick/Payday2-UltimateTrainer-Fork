...
function UT.Construction.save()
    if not UT.checkTable(UT.Construction.units) then
        UT.showMessage("nothing to save", UT.colors.red, "construction")
        return
    end
    ...
    if result then
        UT.showMessage("save success", UT.colors.green, "construction")
    else
        UT.showMessage("save fail", UT.colors.red, "construction")
    end
end
...
function UT.Construction.load(units)
    ...
    if result then
        UT.showMessage("load success", UT.colors.green, "construction")
    else
        UT.showMessage("load fail", UT.colors.red, "construction")
    end
end
...
function UT.Construction.delete(time)
    ...
    local result = UT.setConstructions(constructions)
    if result then
        UT.showMessage("delete success", UT.colors.green, "construction")
    else
        UT.showMessage("delete fail", UT.colors.red, "construction")
    end
end

function UT.Construction.clear()
    if not UT.checkTable(UT.Construction.units) then
        UT.showMessage("nothing to clear", UT.colors.red, "construction")
        return
    end
    ...
    UT.showMessage("clear success", UT.colors.green, "construction")
end
...
function UT.Construction.toggleCrosshair()
    ...
    if UT.Construction.crosshair.enabled then
        ...
        UT.showMessage("crosshair disabled", UT.colors.blue, "construction")
    else
        UT.Construction.crosshair.workspace:show()
        UT.Construction.crosshair.enabled = true
        UT.showMessage("crosshair enabled", UT.colors.blue, "construction")
    end
end
